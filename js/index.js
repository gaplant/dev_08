...
/*################################################# 
#9 My list count wont UPDATE when I add a new item! It works when I delete an item! -BC 

**updateCount was missing its parens, function never fired without. GD
#################################################*/
...
$newItemForm.on('submit', function(e) {       // When a new item is submitted
  ...
  var classDefault = 'class = "favorite"';
  if (text !== "") {                            // checks for empty string 
    /* #11 
      convert text to lowercase
      for each item in list 
      if item value exists already within list
          fire off warning alert, but do nothing to list
      otherwise, add item to list and display    */                                  
    $list.append('<li ' + classDefault + '>' + text + '</li>');      // Add item to end of the list
